...
//
//  Line 10: Using the app.use function to define the endpoint '/' and passing it the variable "route" as an argument
//  Line 10: This points the server to the route.js module for available routes
//
